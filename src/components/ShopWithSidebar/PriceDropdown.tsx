...
import { setPriceRange } from '../../store/slices/autoPartsSlice';
...
const PriceDropdown = () => {
  ...
  const { filters } = useAppSelector((state) => state.autoPartsReducer);
  const [toggleDropdown, setToggleDropdown] = useState(true);

  const [selectedPrice, setSelectedPrice] = useState({
    from: filters.minPrice || 0,
    to: filters.maxPrice || 10000,
  });
          ...
          <div className="price-range">
            <RangeSlider
              ...
              onInput={(e) => {
                ...
                dispatch(setPriceRange({ min: newPrice.from, max: newPrice.to }));
              }}
            />
