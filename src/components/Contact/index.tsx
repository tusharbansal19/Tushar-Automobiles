          ...
          <div className="flex flex-col xl:flex-row gap-7.5">
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  <p className="flex items-center gap-4">
                    ...
                    Tushar Automobiles And Spare Parts
                  </p>
                  ...
                  <p className="flex items-center gap-4">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path d="M2 4h18v14H2z" fill="none" />
                    </svg>
            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder="e.g., Brake pads for Maruti Swift 2018"
                      className={`rounded-md border ${errors.subject ? 'border-red' : 'border-gray-3'} bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20`}
                      disabled={isLoading}
                    />
                    {errors.subject && (
                ...
                <div className="mb-5">
                  <label htmlFor="inquiryType" className="block mb-2.5">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="rounded-md border border-gray-3 bg-gray-1 text-dark w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
                    disabled={isLoading}
                  >
                    <option value="spare-parts">Spare Parts Inquiry</option>
                    <option value="engine-parts">Engine Parts & Oil</option>
                    <option value="brake-system">Brake System Parts</option>
                    <option value="electrical">Lights & Electrical</option>
                    <option value="wheels-tyres">Wheels & Tyres</option>
                    <option value="filters">Filters & Air Systems</option>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Please provide details about your vehicle (make, model, year) and the specific parts you need. For example: 'I need brake pads for my 2018 Maruti Swift VDI. Please let me know the price and availability.'"
