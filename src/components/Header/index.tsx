              ...
              <div className="flex items-center gap-5">
                {isAuthenticated ? (
                  <div className="relative group">
                    ...
                    {/* Dropdown Menu */}
                    <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                      <div className="py-2">
                        <Link href="/my-account" className="block px-4 py-2 text-sm text-dark hover:bg-gray-1 transition-colors">
                          My Account
                        </Link>
                        <Link href="/orders" className="block px-4 py-2 text-sm text-dark hover:bg-gray-1 transition-colors">
                          My Orders
                        </Link>
                        <Link href="/wishlist" className="block px-4 py-2 text-sm text-dark hover:bg-gray-1 transition-colors">
                          Wishlist
                        </Link>
                        <hr className="my-2 border-gray-3" />
                        <button
                          onClick={logout}
                          className="block w-full text-left px-4 py-2 text-sm text-red hover:bg-gray-1 transition-colors"
                        >
                          Sign Out
                        </button>
                      </div>
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-red text-custom-sm font-medium text-dark flex ${stickyMenu ? "xl:py-4" : "xl:py-6"
                            }`}
                        >
                          {menuItem.title}
                        </Link>
