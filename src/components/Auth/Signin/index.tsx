        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            <div className="text-center mb-11">
              ...
              <p>Welcome back to Tushar Automobiles</p>
            </div>
            ...
            <div>
              <form onSubmit={handleSubmit}>
                ...
                <LoadingButton
                  ...
                  variant="primary"
                  size="lg"
                  className="w-full mt-7.5 bg-red hover:bg-red/90"
                ...
                <Link
                  ...
                  className="block text-center text-dark-4 mt-4.5 ease-out duration-200 hover:text-red"
                >
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signup"
                    className="text-red ease-out duration-200 hover:text-red/80 pl-2 font-medium"
                  >
                    Sign Up Now!
                  </Link>
                </p>
